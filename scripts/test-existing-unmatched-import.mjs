...
try {
  ...
  assert.equal(patchCalls, 0, 'existing deals with unmatched referrers should not be patched')
  assert.equal(result.summary.updated, 0, 'existing unmatched referrer rows should not count as updated')
  assert.equal(result.summary.skipped, 1, 'existing unmatched referrer rows should be skipped')
