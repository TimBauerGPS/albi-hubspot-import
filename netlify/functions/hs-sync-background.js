 ...
 *
 * Netlify Background Function — runs for up to 15 minutes with no timeout.
 * Netlify returns a 202 to the client immediately; this function continues in the background.
 *
 ...
 *
 * Accept an optional `type` body param ('contacts' | 'companies' | 'deals') so the
 * frontend can fire three separate requests. Without `type`, syncs all three.
 *
